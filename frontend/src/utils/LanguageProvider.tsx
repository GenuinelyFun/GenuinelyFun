...
import journalPageText from '../pages/journalpage/articlePageText.json';
import techBestPracticePageText from '../pages/journalpage/techBestPracticePageText.json';
import reflectiveThinkingPageText from '../pages/journalpage/reflectiveThinkingPageText.json';
